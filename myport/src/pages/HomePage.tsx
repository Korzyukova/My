    ...
    <div className={containerClasses}>
      ...
      >
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          {/* Блок с фото */}
          <div className="flex-shrink-0 w-full md:w-1/2 rounded-lg shadow-md overflow-hidden"> {/* Изменено: md:w-2/3 */}
            <img src="/me2.jpg" alt="Tatiana Korzyukova" className="w-full h-full object-cover" />
          </div>
          {/* Блок с описанием */}
          <div className="flex-1 text-justify md:w-1/2"> {/* Изменено: md:w-1/3 */}
